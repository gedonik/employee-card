      ...
      <li v-for="person in searchEmployee" :key="person.id"
        ...
        <div class="item-wrapper d-flex justify-content-between align-items-center">
          ...
          <div class="item-widgets">
            <label class="checkbox__item checkbox-promo me-3" for="promo">
              <input class="checkbox__input checkbox-promo__input" type="checkbox" id="promo"/>
              <span class="checkbox__fake checkbox-promo__fake">
            ...
            <label class="checkbox__item checkbox-bonus me-3" for="bonus">
              <input class="checkbox__input checkbox-bonus__input" type="checkbox" id="bonus"/>
              <span class="checkbox__fake checkbox-bonus__fake">
              <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-star"
                   viewBox="0 0 16 16">
                <path
...
.checkbox-promo__input:checked + .checkbox-promo__fake {
  svg {
    path {
      fill: #4fd729;
    }
...
.checkbox-bonus__input:checked + .checkbox-bonus__fake {
  svg {
    path {
      fill: #f3ad2d;
    }
